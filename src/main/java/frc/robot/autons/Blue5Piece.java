...
public class Blue5Piece extends SequentialCommandGroup {
	...
	private Command[] sequence = {
			...
			new ParallelCommandGroup(new RevUpCommand(false, ShooterConstants.shootDps).withTimeout(15),
					...
					new SequentialCommandGroup(new WaitCommand(3.7), new ShootCommand().withTimeout(0.5)),
					...
					new SequentialCommandGroup(new WaitCommand(13.5), new AutoShootCommand().withTimeout(1.0)),
					new SequentialCommandGroup(new WaitCommand(14.7), new ShootCommand().withTimeout(1.0)),
