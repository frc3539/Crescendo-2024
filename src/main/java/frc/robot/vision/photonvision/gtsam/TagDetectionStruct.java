...
public class TagDetectionStruct implements Struct<TagDetection> {
	...
	public TagDetection unpack(ByteBuffer bb) {
		return new TagDetection(bb.getInt(), List.of(new TargetCorner(bb.getDouble(), bb.getDouble()),
				new TargetCorner(bb.getDouble(), bb.getDouble()), new TargetCorner(bb.getDouble(), bb.getDouble()),
